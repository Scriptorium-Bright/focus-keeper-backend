...
import com.focuskeeper.reboot.recovery.friction.dto.GenerateFrictionSignalsRequest;
...
/**
 * 반복 실패와 늦은 재시작 같은 friction signal을 생성/조회하는 API 진입점이다.
 */
public class FrictionSignalController {
    ...
    /**
     * 문자열 날짜를 friction signal 계산 기준일로 파싱하고 형식 오류를 공통 예외로 변환한다.
     */
